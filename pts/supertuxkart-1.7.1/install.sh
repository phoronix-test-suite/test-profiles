#!/bin/sh
rm -rf SuperTuxKart-1.5-beta1-linux
if [ $OS_ARCH = "aarch64" ]
then
	tar -xf SuperTuxKart-1.5-beta1-linux-arm64.tar.gz
	mv SuperTuxKart-1.5-beta1-linux-arm64 SuperTuxKart-1.5-beta1-linux
else
	tar -xf SuperTuxKart-1.5-beta1-linux-x86_64.tar.gz
	mv SuperTuxKart-1.5-beta1-linux-x86_64 SuperTuxKart-1.5-beta1-linux
fi
cat > config.xml <<'EOT'
<?xml version="1.0"?>
<stkconfig version="8" >
...
cd SuperTuxKart-1.5-beta1-linux
./run_game.sh \$@ 2>&1
